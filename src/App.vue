<template>  
  <nav class="fixed w-full bg-white border-stone-200 px-2 sm:px-4 py-2.5 rounded dark:bg-stone-900 z-50">
    <div class="container flex flex-wrap items-center justify-between mx-auto">
      ...
      <!-- 手機板menu -->
      <button type="button" @click="NavMenuOpen()" class="inline-flex items-center p-2 ml-3 text-sm rounded-lg md:hidden hover:bg-stone-100 focus:outline-none focus:ring-2 focus:ring-stone-200  dark:hover:bg-stone-700 dark:focus:ring-stone-600">
        <span class="sr-only">Open main menu</span>
        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M3 5a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 10a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1zM3 15a1 1 0 011-1h12a1 1 0 110 2H4a1 1 0 01-1-1z" clip-rule="evenodd"></path></svg>
      </button>

      <!-- mobile dark mode -->
      <button id="theme-toggle" type="button" @click="darkMode()" class="md:hidden  block pl-3 pr-4 hover:bg-stone-100 dark:hover:bg-stone-700 focus:outline-none focus:ring-4 focus:ring-stone-200 dark:focus:ring-stone-700 rounded-lg text-sm">
      ...
      <div :class="this.isNavOpen ? '' : 'hidden'" class="w-full md:block md:w-auto" id="navbar-default">
        <ul class="flex flex-col p-4 mt-4 border border-stone-100 rounded-lg bg-stone-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-stone-800 md:dark:bg-stone-900 dark:border-stone-700">
      ...
      <!-- large dark mode -->
      <button id="theme-toggle" type="button" @click="darkMode()" class="max-md:hidden text-stone-500 block pl-3 pr-4 dark:text-stone-400 hover:bg-stone-100 dark:hover:bg-stone-700 focus:outline-none focus:ring-4 focus:ring-stone-200 dark:focus:ring-stone-700 rounded-lg text-sm">
        <svg aria-hidden="true" id="theme-toggle-dark-icon" class="w-5 h-5" :class="[this.isDark ? '' : 'hidden']" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path d="M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z"></path></svg>
